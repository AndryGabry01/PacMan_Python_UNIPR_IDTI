...
from PacManAudio import PacMan_PlayAudio as pm_audio
...
class PacManGame:
    def __init__(self):
        ...
        self._audio = pm_audio()

        self._startGameCounter = 80
        ...
        self._ghost = [
            ...
            Ghost(self._arena, self, 0, 0 + self._startGameCounter, (20, 0), 1, (112,88)),
            Ghost(self._arena, self, 1, 20 + self._startGameCounter, (210, 0), 2, (112,88)),
            Ghost(self._arena, self, 2, 40 + self._startGameCounter, (210, 256), 1, (112,88)),
            Ghost(self._arena, self, 3, 60 + self._startGameCounter, (20, 256), 2, (112,88)),
        ]
    ...
    def game_over(self) -> bool:
        isover = self._heros_life <= 0
        if isover:
            self._audio.stopActorSound()
        return isover

    def game_won(self) -> bool:
        iswon = self._remaining_biscotti == 0
        if iswon:
            self._audio.stopActorSound()
        return iswon
